      ...
      <div className="grid-2 contact-grid">
        ...
        <div className="contact-info-column glass-card p-large">
          ...
          <div className="contact-details-list">
            {/* Email */}
            <a href="mailto:raihanul409@gmail.com" className="contact-detail-item">
              ...
              <div className="contact-detail-text">
                ...
                <span className="contact-value">raihanul409@gmail.com</span>
              </div>
            </a>

            {/* Phone */}
            <a href="tel:+8801600357965" className="contact-detail-item">
              ...
              <div className="contact-detail-text">
                ...
                <span className="contact-value">01600357965</span>
              </div>
            </a>

            {/* WhatsApp */}
            <a href="https://wa.me/8801600357965" target="_blank" rel="noopener noreferrer" className="contact-detail-item">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="raihanul409@gmail.com"
              />
